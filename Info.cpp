...
//  ofstream fout("Pc.txt");
    ...
    while (getline(fin, str)) {
        ...
        i = str.find("_");
        oldPc.SetCategory((str.substr(0, i))); // Divide str by spacebar and get category number
        str = str.substr(i+1);
